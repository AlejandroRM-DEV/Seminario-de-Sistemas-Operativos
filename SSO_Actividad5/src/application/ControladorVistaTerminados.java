...
public class ControladorVistaTerminados{
	...
	public void configurar(Stage temp, ObservableList<Proceso> lista){
        ...
        llegada.setCellValueFactory(new PropertyValueFactory<Proceso, Long>("tiempoLlegada"));
        finalizacion.setCellValueFactory(new PropertyValueFactory<Proceso, Long>("tiempoFinalizacion"));
        retorno.setCellValueFactory(new PropertyValueFactory<Proceso, Long>("tiempoRetorno"));
        respuesta.setCellValueFactory(new PropertyValueFactory<Proceso, Long>("tiempoRespuesta"));
        espera.setCellValueFactory(new PropertyValueFactory<Proceso, Long>("tiempoEspera"));
        servicio.setCellValueFactory(new PropertyValueFactory<Proceso, Long>("tiempoServicio"));
