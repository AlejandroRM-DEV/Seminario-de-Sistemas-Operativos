	...
	private void hilos(){
		actualizadorGUI = new Thread(new Task<Void>(){
			...
			private void iniciaSiguienteProceso(){
				...
				if ( procesoActual.getOperacion() != Operacion.INDEFINIDA ) {
					rellenaCampos(Integer.toString(procesoActual.getId()), String.valueOf(procesoActual.getOperacion()),
							Double.toString(procesoActual.getArgA()), Double.toString(procesoActual.getArgB()),
							Long.toString(procesoActual.getTiempo()), Long.toString(procesoActual.getTiempoRestante()),
			...
			private void rellenaCampos(String id, String operacion, String opA, String opB, String tiempoEstimado,
					String tiempoRestante, String tiempoTranscurrido){
				Platform.runLater(() -> {
			...
			private void terminaIniciaSiguienteProceso(){
				...
				Platform.runLater(() -> {
					observableListListos.remove(procesoActual);
					observableListTerminados.add(procesoActual);
				});
